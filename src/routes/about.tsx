    ...
    <Shell>
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-[var(--color-ink-soft)] mt-4 leading-loose">
          <span className="font-bold text-[var(--color-gold)]">تاج الملوك</span> هو مركز متكامل للعناية بالسيارات في صنعاء، نقدّم تجربة فاخرة تجمع بين متجر إلكتروني واسع وخدمات احترافية تنفذها أيدي خبراء. هدفنا أن تحصل سيارتك على أفضل العناية في مكان واحد، بجودة عالمية وأسعار تنافسية.
        </p>
        <p className="text-[var(--color-ink-soft)] mt-4 leading-loose">
