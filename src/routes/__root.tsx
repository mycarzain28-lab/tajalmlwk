...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tajalmlwk Car Care and Accessories" },
      ...
      { property: "og:title", content: "Tajalmlwk Car Care and Accessories" },
      { property: "og:description", content: "تاج الملوك - مركز ومتجر وخدمات متكاملة للعناية بالسيارات في صنعاء. PPF، نانو سيراميك، تنجيد، اكسسوارات، ومنتجات فاخرة. شارع 22 مايو أمام فندق الأحلام قبل جولة الثقافة" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Tajalmlwk Car Care and Accessories" },
      { name: "twitter:description", content: "تاج الملوك - مركز ومتجر وخدمات متكاملة للعناية بالسيارات في صنعاء. PPF، نانو سيراميك، تنجيد، اكسسوارات، ومنتجات فاخرة. شارع 22 مايو أمام فندق الأحلام قبل جولة الثقافة" },
